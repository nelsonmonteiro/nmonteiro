...
cd /home/ubuntu/sites/nmonteiro/repository
source ../env/bin/activate
export PYTHONPATH=$PYTHONPATH:/home/ubuntu/sites/nmonteiro/repository/nmonteiro
test -d $LOGDIR || mkdir -p $LOGDIR
exec ../env/bin/gunicorn nmonteiro.configs.development.wsgi:application -w $NUM_WORKERS --bind=$ADDRESS \
